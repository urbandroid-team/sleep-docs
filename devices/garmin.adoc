...
*Check the setup:* Make sure you do NOT have the *Sleep Garmin addon* from the Play Store installed on the phone - it is a legacy app, that can break the connection.
...
=== Vibrations when tracking starts/ends?
...
=== Backlight turning on during sleep?

To prevent the screen from lighting up when you move in bed, navigate to _Settings -> System -> Lighting -> During Activity -> Gesture_ and set it to Off.
...
=== Cannot Start Tracking from Phone?
