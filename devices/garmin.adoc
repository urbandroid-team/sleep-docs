...
* On the watch: Install the current version of the watch app https://apps.garmin.com/en-US/apps/e80a4793-f5a3-44c7-bd7f-52a97f5d8310[thourgh the ConnectIQ Store] (Connect IQ 3.1 and higher).
...
. To start sleep tracking with your watch, tap _Start tracking_ on the <</ux/homescreen#,Homescreen>> on the phone and then start on the watch.
...
* Garmin Descent G1, Descent Mk2, Descent Mk2S, Descent Mk3 43mm, Descent Mk3 51mm
* Garmin Enduro, Enduro 3
...
* Garmin fēnix 7, fēnix 7 Pro, fēnix 7S, fēnix 7S Pro, fēnix 7X, fēnix 7X Pro
* Garmin fēnix 8 43mm, fēnix 8 47mm, fēnix 8 Solar 47mm, fēnix 8 Solar 51mm
