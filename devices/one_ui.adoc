...
NOTE: Make sure the sleep tracking activity is allowed in the background within Wear app in _Galaxy Wear > Watch settings > Apps > Sleep / Sleep tracking > Allow background activity_.
