...
Statistics show the most important dimensions (Duration, Deep sleep, Snoring) of your <</docs/theory/sleepscore.html,Sleep score>> aggregated by days or optionally by <</docs/tags,Tags>>.
