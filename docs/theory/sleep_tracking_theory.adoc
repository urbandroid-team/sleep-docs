...
* <</docs/alarms/alarm_settings#gentle_alarm,Gentle alarm volume increase>> & <</docs/connected_devices/smart_light#sunrise_alarm_guide,gentle alarm light increase / sunrise alarm>>
