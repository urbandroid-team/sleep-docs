...
The source of flashes will be the phone's LED or a smartlight if you have it set up (see <</docs/connected_devices/smart_light,Smartlight>> to find out how to do that).
