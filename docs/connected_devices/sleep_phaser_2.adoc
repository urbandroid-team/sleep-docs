...
The light can also be controlled via Sleep app – bottom menu during <</docs/sleep_basic/sleep_tracking,sleep tracking>>.
...
<</docs/sleep_basic/sleep_tracking,Sleep tracking>> with Sleep Phaser can be started either manually or automatically.
...
. enable _Settings -> Sleep tracking -> <</docs/sleep_advanced/pair_tracking,Pair tracking>>_ on both phones
