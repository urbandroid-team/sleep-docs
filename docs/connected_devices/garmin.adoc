...
Does your watch support the ConnectIQ platform? link:https://www.wareable.com/garmin/garmin-connect-iq-guide-best-apps-122[check here] (Garmin does not have an official list).
