...
Enable HR monitoring for fully integrated devices::
  ...
  This regards all devices that we explicitly integrated, such as Pebble, Mi Band, Fitbit, Garmin, Wear OS, Samsung Gear/Galaxy. See <</docs/devices/smartwatch_wearables#,Smartwatch and Wearables>> for supported devices.
...
Enable HR monitoring for a supported oximeter:: If you have an <</docs/devices/oximeter#,oximeter>> connected in _Sleep -> Settings -> Wearables -> Pulse Oximeter_, heart rate will be detected by default.
