...
Starts the backup sync – export a CSV file, backup to Sleepcloud, Dropbox and Google Drive if connected. See <</docs/sleep/backup_data#,Backup data>>.
...
NOTE: Make sure <</docs/sleep/lucid_dreaming#,Lucid dreaming>> is enabled in settings
