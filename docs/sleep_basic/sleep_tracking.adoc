...
. Use link:/docs/alarms/smart_wake_up.html[smart wake up] for the alarm

TIP: link:/docs/theory/sleep_tracking_theory.html[Go here for a more in-depth read on sleep tracking].
...
## Options
[horizontal]
Smart wake up:: See link:/docs/alarms/smart_wake_up.html[Smart wake up]
...
.Pair tracking
[horizontal]
Pair tracking:: Check to enable pair tracking. More details: link:/docs/sleep_advanced/pair_tracking.html[Pair tracking].
