...
. Monitor your long term sleep quality (with <</docs/theory/sleepscore,sleep score>> and statistics)
. Set up goals to improve your sleep quality
. Use <</docs/alarms/smart_wake_up,smart wake up>> for the alarm

TIP: <</docs/theory/sleep_tracking_theory,Go here for a more in-depth read on sleep tracking>>.
...
== Options
[horizontal]
Smart wake up:: See <</docs/alarms/smart_wake_up,Smart wake up>>
...
.Pair tracking
[horizontal]
Pair tracking:: Check to enable pair tracking. More details: <</docs/sleep_advanced/pair_tracking,Pair tracking>>.
