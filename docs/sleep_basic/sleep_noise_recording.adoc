...
== What it does
Records significant sounds while you sleep and builds a noise profile for the night. It also <</docs/sleep_basic/sound_recognition#,classifies the sounds>> into categories.
