...
## Guide
[horizontal]
How to get rid off a card on Dashboard::
Any card can be simple swipe away from the dashboard. You can also use the Hide / Show button at the bottom of Dashboard.
How to get rid off a tab on Tabs::
Open the last Tab with icon:ic_puzzle[] icon, and untick any tab you wish to hide.
You can also personalize the Tabs in _Settings -> Personalize -> Show tab_.
How to get a lost tab on Tabs::
Open the last Tab with icon:ic_puzzle[] icon, and tick any tab you wish to show.
You can also personalize the Tabs in _Settings -> Personalize -> Show tab_.
How to get the hidden Dashboard card back::
