...
== What it does
*Setup your alarms so that you wake up refreshed with link:/docs/alarms/smart_wake_up.html[Smart wake up], <<gentle>>, link:/docs/connected_devices/smart_light.html[Smartlight] and other features.*

Sleep as Android makes sure even sleepyheads wake up on time with link:/docs/alarms/captcha.html[CAPTCHA].
...
[horizontal]
Ringtone:: See link:/docs/alarms/ringtone.html[Ringtone].
...
* Disabled - Alarm rings at system's alarm stream volume (or media stream when using streaming services or changing the _Alarm output_ settings). For more details see the link:/docs/alarms/ringtone.html[Ringtone] section.
...
Alarm sound start::
You may want to first give chance to link:/docs/connected_devices/smart_light.html[Smartlight] or vibrations to wake you up, before the alarm starts sounding.
...
.Snooze / Dismiss
[horizontal]
Snooze:: See link:/docs/alarms/snooze.html[Snooze].
...
.Backup alarm
[horizontal]
Backup alarm:: See link:/docs/alarms/backup.html[Backup alarm].
Alarm timeout:: See link:/docs/alarms/backup.html[Backup alarm].
