...
NOTE: For even better wakeup experience, see also link:/docs/alarms/smart_wake_up.html[Smart wake up]
...
* Disabled - Alarm rings at volume set in link:/docs/alarms/ringtone.html[Ringtone] section.
