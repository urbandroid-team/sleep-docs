...
Most of all:
* <</docs/alarms/smart_wake_up#,Smart wake up>> wakes you at the right sleep phase
* <<gentle_alarm, Gentle volume increase>> finds the minimal sound to wake you
* <</docs/devices/smart_light#,Smartlight>> natural sunrise wake up
* and many more.

We makes sure even sleepyheads wake up on time with our <</docs/alarms/captcha#,CAPTCHA>> feature.
...
Alarm sound start::
You may want to first give chance to <</docs/devices/smart_light#,Smartlight>> or vibrations to wake you up, before the alarm starts sounding.
