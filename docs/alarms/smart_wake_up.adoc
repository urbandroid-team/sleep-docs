...
* Power nap - special type of smart period which wakes you after the alarm time, see <</docs/alarms/power_nap#,Power nap>>
...
* Power nap - See <</docs/alarms/power_nap#,Power nap>>
* 5 minutes - 2 hour - alarm goes of during the selected period prior to alarm time
