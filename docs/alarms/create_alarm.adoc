...
[horizontal]
Time picker:: You can choose between analog clock time picker (default) and wheel time picker (This can be configured in <</docs/ux/personalize#,_Settings -> Personalize -> Analog time picker_>>).
