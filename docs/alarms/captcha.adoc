...
- _link:/docs/alarms/alarm_settings.html#per-alarm[Alarm-specific settings] -> CAPTCHA: Stop oversleeping!_
...
== Options
[horizontal]
Default CAPTCHA:: CAPTCHA for all alarms where you don't have a alarm-specific CAPTCHA set.
