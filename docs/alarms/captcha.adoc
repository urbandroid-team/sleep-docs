...
- _<</docs/alarms/alarm_settings#per-alarm,Alarm-specific settings>> -> CAPTCHA: Stop oversleeping!_
...
== Options
[horizontal]
Default CAPTCHA:: CAPTCHA for all alarms (not overridden by <</docs/alarms/alarm_settings#per-alarm,Alarm-specific settings>>
