...
== Where to find it
*Left ☰ menu -> Advice* or from the <</docs/ux/homescreen#advicecard,Advice>> dashboard card.
...
* Does it meets your <</docs/sleep/ideal_daily_sleep#,Ideal daily sleep>> target?
...
Caution:: Shows a worsening with tips on how to improve and links to setup <</docs/sleep/goals#,Goals>>.
