...
a|*Sleep score* radar chart is another way of looking at your <</docs/sleep/sleepscore#,sleep score>>.
...
- *Blue line*: shows the deficit on a given day. If you sleep less then your <</docs/sleep/ideal_daily_sleep#,ideal sleep time>>, the blue line will be negative on that day. If you sleep more, it will be positive.
...
=== Chronotype
Chronotype is a term used to characterise your sleep patterns. It is a spectrum ranging from 100% night owl to 100% morning lark. <</docs/sleep/chrono_jetlag#chronotype,Read more on Chronotype>>.
...
Most importantly, the sleeps are divided into two clusters - *Working days* and *Free days* (<</docs/sleep/chrono_jetlag#workdays-and-weekend-days,see explanation>>)
