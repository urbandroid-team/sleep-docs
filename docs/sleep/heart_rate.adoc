...
Enable HR monitoring for fully integrated devices::
  ...
  This regards all devices that we explicitly integrated, such as Pebble, Mi Band, Fitbit, Garmin, Wear OS, Samsung Gear/Galaxy. See <</docs/devices/wearables#,Smartwatch and Wearables>> for supported devices.
