...
You can also see your actual chronotype and chronotype trend in <</docs/sleep/charts#chronotype,Charts>>.
...
You can see your actual social jet lag in <</docs/sleep/charts#,Charts>>.
...
Sleep as Android tracks your sleep irregularity and shows you in <</docs/sleep/charts#,Charts>> how irregular your sleep is.
