...
. Monitor your long term sleep quality (with <</docs/sleep/sleepscore#,sleep score>> and statistics)
. Set up goals to improve your sleep quality
. Use <</docs/alarms/smart_wake_up#,smart wake up>> for the alarm

TIP: <</docs/sleep/sleep_tracking_theory#,Go here for a more in-depth read on sleep tracking>>.
...
.Pair tracking
[horizontal]
Pair tracking:: Check to enable pair tracking. More details: <</docs/sleep/pair_tracking#,Pair tracking>>.
