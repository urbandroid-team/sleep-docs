...
Sleep score card [[sleepscore]]:: See <</docs/sleep/sleepscore#,Sleep score>>.
* Tapping on this card opens Stats (see <</docs/sleep/statistics#,Stats>>)
Graphs card:: Shows you graphs from the <</docs/sleep/charts#,Charts section>>.
...
Noise card:: TODO
Charts card:: Shows you graphs from the <</docs/sleep/statistics_charts#,Charts section>>.
* Tapping on this card opens <</docs/sleep/statistics_charts#,Charts section>>.
Advice card [[advicecard]]:: Shows the current advice.
* Tapping on this card opens <</docs/sleep/Advice#,Advice section>>.
...
Stats tab:: Shows <</docs/sleep/statistics_charts#,statistics charts>>.
Graphs tab:: Shows list of <</docs/sleep/sleep_graph#,Graphs>>.
Noise tab::  Shows the list of <</docs/sleep/sleep_noise_recording#,Noise recording>>.
