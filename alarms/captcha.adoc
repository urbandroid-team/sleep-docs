...
Additional check for heavy sleepers - after the alarm goes off, you will be asked if you are really awake with a notification. You have to confirm this notification to prove it!

After the alarm has gone off and you dismiss it, a notification will appear in your notifications - you need to confirm that you are awake by tapping the "I'm awake!" button on this notification.
If you do not confirm the notification, the alarm will go off again.

image::wake-up_check.png[]

=== Check after
How long after tha alarm dismiss the notification appears.

=== Time to confirm
How much time you have to confirm the notification before the alarm goes off again.

=== Repeat
How many times the app repeats the alarm, if the wake-up check is not confirmed.

[EXAMPLE]
The alarm goes off at 06:30 and you dismiss it after 2 minutes. Now you have 10 minutes to slowly get up (10-minute "Check after"). After these 10 minutes a notification is shown. You have five minutes (5-minute "Time to confirm) to find the notification and tap the button.
You did confirm the notification = the alarm is completely finished.
You did not confirm the notification = the alarm goes off again, you need to dismiss it and then confirm the notification.

=== Notification ringtone
Takes you to the system settings with additional settings of the notification behavior. You can configure it to be Silent, change the ringtone, have it override the DND...
...
Find a sleeping sheep hidden in a flock of awake sheep and wake it by tapping.
...
WARNING: Location is saved only with sleep tracking results. So you need at least *5 sleep graphs* with location from the same place.
...
The difficulty of this task depends on the difficulty configured for the NFC or QR CAPTCHA in _Settings -> Alarms -> CAPTCHA -> Difficulty_.
...
=== Wake the droid
Wake the droid by using super-laud instruments.

=== Maze
By tilting your device, let the sleeper get to the bathroom.

=== Jumping sheep
Guide the lost sheep through the fences and wolves to safety - tap to jump over obstacles.

=== Memoji
Memory task with emojis - remember the emojis and their exact order.
...
=== Sleeping sheep - Legacy (CAPTCHA add-on)
Find an awake sheep hidden in a flock of sleeping sheep and wake it by tapping.
...
=== Jumping sheep - Legacy (CAPTCHA add-on)
Guide the lost sheep through the fences and wolves to safety - tap to jump over obstacles.
...
=== Let there be light - Legacy (CAPTCHA add-on)
Hold your phone up to a light source and hold it until the threshold is reached.
