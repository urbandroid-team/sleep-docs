...
See <</sleep/smart_wake_up#,Smart wake up>>.
...
NOTE: Gentle volume timer starts when the alarm starts, it is not postponed by the Delayed sound start.
...
NOTE: Delayed sound start will not postponed the start of the gentle volume increase.
