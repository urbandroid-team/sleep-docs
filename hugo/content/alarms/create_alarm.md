...
- **Alarm icon icon:ic_alarm_plus[]**: in the search bar (Tabs layout) ![](set_alarm_2.png)
- **Alarm icon icon:ic_alarm_plus[]**: on the alarm card (Dashboard layout) ![](set_alarm_3.png)
...
- **Wake up at an ideal time**: Tap on the icon:ic_target[] button or **GOAL** button. The time is scheduled to reach your [Daily sleep duration goal](/sleep/ideal_daily_sleep).
