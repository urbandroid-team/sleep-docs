...
1. That section will zoom in for more precise selection with the handles.
1. For fine-grained selection, you can enter adjust the time manually in the upper bar.
1. When the period is selected, tap on the scissors icon in the upper right corner.
