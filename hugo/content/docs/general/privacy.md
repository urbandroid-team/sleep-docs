...
> [!NOTE]
> The app only ever uses **coarse location** (±5 km accuracy) for [geotagging](/docs/sleep/tags#geo) and home location detection; your exact address is never stored.
...
> [!TIP]
> Ads are **only** present in the free version of the app after the initial trial period has expired. If you see ads in a premium or unlocked version, please see our [FAQ for troubleshooting purchases](/docs/faqs/purchase_not_unlocked).
...
### SleepCloud
Quick access to manage your [SleepCloud](/docs/services/sleepcloud) account and synchronization settings.
...
### Weather
Enables coarse location checks to provide the weather forecast on your [Morning Briefing](/docs/sleep/how_to_read_sleep_graphs#morning_screen).
