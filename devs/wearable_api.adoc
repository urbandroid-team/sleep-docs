...
*** com.urbandroid.sleep.EXTRA_DATA_HR - heart rate
*** com.urbandroid.sleep.EXTRA_DATA_RR - R-R intervals - intervals between consecutive heart beats
*** com.urbandroid.sleep.EXTRA_DATA_SPO2 - blood oxygenation measure
*** com.urbandroid.sleep.EXTRA_DATA_SDDN - short-term heart rate variability
