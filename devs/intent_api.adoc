...
** alarm_id: alarm's unique identifier (int)  - retrievable from <</devs/content_provider_api#,the alarm content provider>>.
...
alarm_wake_up_check:: `com.urbandroid.sleep.alarmclock.ALARM_WAKE_UP_CHECK_AUTO`
