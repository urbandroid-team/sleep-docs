...
NOTE:: In preview tests, both the phone and connected wearable will vibrate, in real life only one will vibrate - if you are using a wearable for sleep tracking, only the wearable will vibrate for lucid cues.
