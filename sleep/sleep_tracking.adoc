...
. Monitor your long term sleep quality (with <</sleep/sleepscore#,sleep score>> and statistics)
. Set up goals to improve your sleep quality
. Use <</alarms/smart_wake_up#,smart wake up>> for the alarm

NOTE: See <</sleep/sleep_tracking_theory#, Sleep tracking theory>> for a more in-depth information on sleep tracking.
