...
_Settings -> Lullaby_ (for general settings)
_Left_ ≡ _menu -> Lullaby_ (for choosing a lullaby)
icon:ic_action_lullaby[] _icon on the tracking screen_ (for choosing a lullaby)
...
Five lullabies are build in for free, five additional lullabies available after unlocking the app and many more with the https://play.google.com/store/apps/details?id=com.urbandroid.sleep.lullaby[Sleep Lullaby extension pack]. This lullaby extension is free for unlocked Sleep app users.
You can purchase the https://play.google.com/store/apps/details?id=com.urbandroid.sleep.addon.lullaby[ Lullaby extension pack] even if you don't wish to use the full version of Sleep app.
...
* Magic
* Medieval tavern
* Meditation (by Universfield)
* Megalith
* Music Box
* NASA Saturn "sound"
* North Wind
* Om chant
* Piano (by Gustavo Alivera)
* Pink Noise
* Planet Nine
* Rain Drop
* Rain stick
...
You can create a playlist from the built-in tracks from the app, and from the Lullaby addon.

== Settings
[horizontal]
Preview:: Plays a preview of your current lullaby
Playlist:: Allows you to play several tracks in order. The app will choose you last X lullaby.
Timeout:: A timeout of individual tracks in the playlist. The app will play one track for x minute, and then will switch to the next in the order. If *disable*, the app will loop one track.
...
.Advanced
[horizontal]
Turn off WiFi after lullaby:: Turns off the WiFi signal once the volume reaches zero. For online radios and streaming services. Available only for older Android versions.
