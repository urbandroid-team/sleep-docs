...
== Smart period
Again a simple automation which starts sleep tracking some time before the smart period. The aim of this option is to have a function <</sleep/smart_wake_up#,Smart wake up>> with minimal battery use. Using this option will provide you with incomplete sleep stats.
