...
[horizontal]
Backs up:: Sleep records, Settings, Noise recordings metadata, Active alarms
...
. On the new phone, decide a location for your new storage path. Choose some accessible location, like Media (don't use Downloads).
