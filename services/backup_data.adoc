...
The backup zip file can be used for migrating your Sleep settings and tracking history to a new phone - see <</sleep/services/new_phone_data_transfer#, our detailed guide>>.
