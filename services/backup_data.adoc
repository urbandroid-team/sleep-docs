...
._Left ☰ menu -> Backup_
[horizontal]
Export data:: Exports all your sleep records to a CSV file located on your phone at _/sdcard/sleep-data/sleep-export.csv_. Use for  <<local_backup,local backup>> or for your <<csv_export, own analysis>> of sleep tracking data.
