...
Set bedtime notification to 5 minutes before and than set an alarm to your ideal time + 8 minutes. Than please wait for 3 minutes and if the notification will not show up, please send us the application log by using Left ≡ menu -> Report a bug.
