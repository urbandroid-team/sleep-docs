...
- Check the volume of the ringtone in _Settings -> Alarms -> Ringtone_ or in the settings of each individual alarm in link:/docs/alarms/alarm_settings.html#per-alarm[per-alarm settings].
