...
Please install the link:https://play.google.com/store/apps/details?id=com.hecz.sleepphasercontrol[Sleep Phaser Remote Control] app, start it up, make sure it connected to your Sleep Phaser, and then start the firmware upload.
