...
[horizontal]
icon:ic_dashboard[] Dashboard:: Opens <</ux/hs_dashboard#,Dashboard>> in Tabs mode.
...
For mode details on Home screen, please see the <</ux/hs_dashboard#,Dashboard>>, <</ux/hr_tabs#,Tabs>>, and <</ux/hs_alarms_only#,Alarms only mode>>.
